...
- [x] **一人称／俯瞰の2つの視点モード**を切り替えられる。どちらも中心は出題地点のままなので、切り替えても立ち位置は変わらない
- [x] **ドラッグで360度ぐるりと見回せる**。回しても**立ち位置は1mmも動かない**（地図の中心が出題地点に固定されている）。矢印キーでも見回せる
- [x] 「真下」を押すと真上から見下ろし、自分がいる地点が画面中央に来る
- [x] **足元のGPXルート（前後10m）だけ**が3D地形の上に描かれる。ルート全体は描かない（どこを歩いているかが一目で分かってしまうため）
